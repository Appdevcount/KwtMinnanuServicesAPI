...
namespace ETradeAPI.Controllers
{
 ...
 [Route("GetBrokerTypesList")]
      ...
      Content = new StringContent(MobileDataBase.CanCreateOrg(R.ParentID,R.Action,R.OrgID), System.Text.Encoding.UTF8, "application/json")
                    
		};
        }
        [Route("GovernorateDetails")]
        [HttpPost]
        public HttpResponseMessage GovernorateDetails([FromBody] ReqObj R)//[FromUri]int ParentID)
        {
            return new HttpResponseMessage()
            {
                Content = new StringContent(MobileDataBase.GovernorateDetails(Convert.ToInt32( R.CommonData)), System.Text.Encoding.UTF8, "application/json")
            };
        }
        [Route("GetGovernorates")]
        [HttpPost]
        public HttpResponseMessage GetGovernorates([FromBody] ReqObj R)//[FromUri]int ParentID)
        {
            return new HttpResponseMessage()
            {
                Content = new StringContent(MobileDataBase.GetGovernorates(), System.Text.Encoding.UTF8, "application/json")
            };
        }
        [Route("GETChildUsers")]
        [HttpPost]
        ...
        public HttpResponseMessage VerifyOTP([FromBody] VerifyOTPParams data)
        {
            return new HttpResponseMessage()
            {
                Content = new StringContent(MobileDataBase.VerifyOTP(data.Email, data.Mobile, data.tokenId, data.mUserid, data.Lang), System.Text.Encoding.UTF8, "application/json")
            };
        }
        ...
        [Route("ExistingOrgRequestFortheUser")]
        [HttpPost]
        public HttpResponseMessage ExistingOrgRequestFortheUser([FromBody] ReqObj data)
        {
            return new HttpResponseMessage()
            {
                Content = new StringContent(MobileDataBase.ExistingOrgRequestFortheUser(data.CommonData), System.Text.Encoding.UTF8, "application/json")
            };
        }
        [Route("ForgotPwdOTP")]
        ...
        [Route("GetCivilIDDetailsFromMoci")]
        [HttpPost]
        public HttpResponseMessage GetCivilIDDetailsFromMoci([FromBody] User R)//[FromUri]int ParentID)
        {
            return new HttpResponseMessage()
            {
                Content = new StringContent(MobileDataBase.GetCivilIDDetailsFromMoci(R), System.Text.Encoding.UTF8, "application/json")
            };
        }

        [Route("GetBrokerAffairsDocsCheck")]
        [HttpPost]
        public HttpResponseMessage GetBrokerAffairsDocsCheck([FromBody] BrokerUpdateModel data)
        {
            return new HttpResponseMessage()
            {
                Content = new StringContent(MobileDataBase.GetBrokerAffairsDocsCheck(data), System.Text.Encoding.UTF8, "application/json")
            };
        }
